/* Luke Langius
 * Trapazoid.java
 * Created a Trapazoid class based off of the Shape class, made new getArea() and getPerimeter() because I extended from the shape class.
 * 4/3/20
 */
public class Trapazoid extends Shape{
    ...
    Trapazoid (double myHeight, double myBase1, double myBase2, double mySide1, double mySide2) {
